...
The ScenePass add-on was created entirely using AI tools. Its source code was generated by AI, and its icon/fanart artwork — along with this repository’s own icon/fanart — were produced through AI image-generation tools.

This disclosure does not apply to the Studio Icons – Coloured – Modded add-on. The logo resources in that project are authentic studio and broadcaster logos, sourced from the community (see its README for credits), and are not AI-generated.

This notice is provided to ensure openness and to comply with applicable regulations regarding AI-generated content.
